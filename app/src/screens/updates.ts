...
export function updatesScreen(updates: UpdateSummary): HTMLElement {
  ...
  page.append(
    ...
    statusCard("Recipe fixture", updates.recipe, "neutral"),
    statusCard("Existing campaigns are never patched in place.", "A future safe live patch path must be explicitly classified and reviewed; this fixture performs no update action.", "warning"),
