...
| `SR_SUBSPELL_FIX` | Spell Revisions fork; legacy destination `chriz-bg-modpack` `180` | FAIL stub in the modpack; migration is already part of the SR-fork design. | Apply automatically after NPC mods whenever the affected SR elemental-protection system is enabled, then retire the legacy component. |
